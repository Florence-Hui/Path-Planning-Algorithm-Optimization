...
from horizon_scheduler import HorizonScheduler
...
class Robot(object):
    ...
    def __init__(self, **kwargs):
        ...
        # Create horizon scheduler (Adaptive MCTS depth)
        ...
        # Create grid for global uncertainty evaluation
        ...
        if self.dimension == 2:
            self.uncertainty_grid = np.vstack([x1.ravel(), x2.ravel()]).T
        elif self.dimension == 3:
            self.uncertainty_grid = np.vstack([
                x1.ravel(),
                x2.ravel(),
